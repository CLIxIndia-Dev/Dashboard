    ...
    state_level.values.forEach(function(district_level){
        ...
        if(district_level.values[district_level.values.length-1].values[0].district_entry == 1)
        {
         ...
         district_level.values.forEach(function(implemented_school_count)
         {
                    ...
                    {
                       chattisgarh_schools_quality[i] = 0;
...
////                        console.log(implemented_school_count_final.values)
         ...
         district_level_no_data_available_school = 30 - (district_level_implemented_school + district_level_not_implemented_school);
         console.log(district_level_implemented_school);
         console.log(district_level_not_implemented_school);
        console.log(district_level_no_data_available_school);
        for(var j=0;j<number_of_quality_school_observations;j++)
         {
           if(chattisgarh_schools_quality[j]<=4)
           {
             number_of_below_average_schools++;
           }
           else if(chattisgarh_schools_quality[j]>4 && chattisgarh_schools_quality[j]<=6)
           {
             number_of_average_schools++;
           }
           else if(chattisgarh_schools_quality[j]>6 && chattisgarh_schools_quality[j]<=8)
           {
